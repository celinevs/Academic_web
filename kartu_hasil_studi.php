  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href="content.php">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="kartu_hasil_studi.php">Kartu Hasil Studi
...
<div class="container">
  <div class="profile-card">
    <h3 class="text-center">Select Academic Semester</h3>
    ...
    <?php
      ...
      $query = "SELECT DISTINCT academic_semester FROM enrolment WHERE s_id = '$s_id_value'";
      ...
      <?php
        if ($res && $res->num_rows > 0) {
          while ($row = $res->fetch_assoc()) {
            echo "<option value='" . $row['academic_semester'] . "'>" . $row['academic_semester'] . "</option>";
          }
        } else {
    ...
    <table class="table table-hover">
      <thead class="thead-dark">
        <tr>
          ...
          <th class="fixed-width">Teacher Name</th>
